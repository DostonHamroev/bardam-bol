...
import uz.hamroev.bardambolnew.databinding.FragmentSuvniTozalashBinding
 ...
 * Use the [SuvniTozalashFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class SuvniTozalashFragment : Fragment() {
    ...
    lateinit var binding: FragmentSuvniTozalashBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSuvniTozalashBinding.inflate(layoutInflater)
    ...
    companion object {
         ...
         * @return A new instance of fragment SuvniTozalashFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SuvniTozalashFragment().apply {
