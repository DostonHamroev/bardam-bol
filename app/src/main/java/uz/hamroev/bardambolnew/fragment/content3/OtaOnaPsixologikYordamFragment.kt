...
import uz.hamroev.bardambolnew.databinding.FragmentOtaOnaPsixologikYordamBinding
 ...
 * Use the [OtaOnaPsixologikYordamFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class OtaOnaPsixologikYordamFragment : Fragment() {
    ...
    lateinit var binding: FragmentOtaOnaPsixologikYordamBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentOtaOnaPsixologikYordamBinding.inflate(layoutInflater)
    ...
    companion object {
         ...
         * @return A new instance of fragment OtaOnaPsixologikYordamFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OtaOnaPsixologikYordamFragment().apply {
