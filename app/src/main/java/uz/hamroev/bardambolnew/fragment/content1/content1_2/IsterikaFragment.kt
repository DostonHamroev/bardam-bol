...
import uz.hamroev.bardambolnew.databinding.FragmentIsterikaBinding
 ...
 * Use the [IsterikaFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class IsterikaFragment : Fragment() {
    ...
    lateinit var binding: FragmentIsterikaBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentIsterikaBinding.inflate(layoutInflater, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment IsterikaFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            IsterikaFragment().apply {
