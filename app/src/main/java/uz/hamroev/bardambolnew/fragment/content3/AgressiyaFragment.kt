...
import uz.hamroev.bardambolnew.databinding.FragmentAgressiyaBinding
 ...
 * Use the [AgressiyaFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class AgressiyaFragment : Fragment() {
    ...
    lateinit var binding: FragmentAgressiyaBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAgressiyaBinding.inflate(layoutInflater, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment AgressiyaFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AgressiyaFragment().apply {
