...
import uz.hamroev.bardambolnew.databinding.FragmentTashvishliChamadonBinding
 ...
 * Use the [TashvishliChamadonFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class TashvishliChamadonFragment : Fragment() {
    ...
    lateinit var binding: FragmentTashvishliChamadonBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentTashvishliChamadonBinding.inflate(layoutInflater, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment TashvishliChamadonFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TashvishliChamadonFragment().apply {
