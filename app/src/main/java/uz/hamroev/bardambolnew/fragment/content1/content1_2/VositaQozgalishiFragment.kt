...
import uz.hamroev.bardambolnew.databinding.FragmentVositaQozgalishiBinding
 ...
 * Use the [VositaQozgalishiFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class VositaQozgalishiFragment : Fragment() {
    ...
    lateinit var binding: FragmentVositaQozgalishiBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentVositaQozgalishiBinding.inflate(layoutInflater, container, false)
    ...
    private fun loadRuData() {
        ...
        listVideo = ArrayList()
        listVideo.clear()
        listVideo.add(Video("Двигательное возбуждение", "Tb4PKmsXPl0", ""))
        list = ArrayList()
        list.clear()
        list.add(
            PdfDownload(
    ...
    companion object {
         ...
         * @return A new instance of fragment VositaQozgalishiFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            VositaQozgalishiFragment().apply {
