...
import uz.hamroev.bardambolnew.databinding.FragmentQorquvXolatidagiBirinchiYordamBinding
...
class QorquvXolatidagiBirinchiYordamFragment : Fragment() {
    ...
    lateinit var binding: FragmentQorquvXolatidagiBirinchiYordamBinding
