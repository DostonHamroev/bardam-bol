...
import uz.hamroev.bardambolnew.databinding.FragmentBolagaBirinchiYordamVideoBinding
 ...
 * Use the [BolagaBirinchiYordamVideoFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BolagaBirinchiYordamVideoFragment : Fragment() {
    ...
    lateinit var binding: FragmentBolagaBirinchiYordamVideoBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBolagaBirinchiYordamVideoBinding.inflate(layoutInflater)
...
//        }
    ...
    private fun loadUzData() {
        ...
        listVideo = ArrayList()
        listVideo.clear()
        listVideo.add(Video("Bola yuzaki jarohat olganda birinchi  yordam", "uh5LLE573aw", ""))
        listVideo.add(Video("Bola chuqur jarohat olganda birinchi  yordam", "nzdCSFAOJqk", ""))
        listVideo.add(Video("Bolada sinishlar kuzatilganda birinchi  yordam", "-pXN7rtlhQQ", ""))
        listVideo.add(Video("Bolada turli xil kuyishlar kuzatilganda birinchi yordam", "7lfWBHQJklg", ""))
        listVideo.add(Video("Cho‘kayotgan bolaga birinchi tibbiy yordam ko‘rsatish", "cvdC9f33uLA", ""))
        list = ArrayList()
        list.clear()
        list.add(
            PdfDownload(
    ...
    private fun loadKrillData() {
        ...
        listVideo = ArrayList()
        listVideo.clear()
        listVideo.add(Video("Бола юзаки жароҳат олганда биринчи  ёрдам", "uh5LLE573aw", ""))
        listVideo.add(Video("Бола чуқур жароҳат олганда биринчи  ёрдам", "nzdCSFAOJqk", ""))
        listVideo.add(Video("Болада синишлар кузатилганда биринчи  ёрдам", "-pXN7rtlhQQ", ""))
        listVideo.add(Video("Болада турли хил куйишлар кузатилганда биринчи ёрдам", "7lfWBHQJklg", ""))
        listVideo.add(Video("Чўкаётган болага биринчи тиббий ёрдам кўрсатиш", "cvdC9f33uLA", ""))
        list = ArrayList()
        list.clear()
        list.add(
            PdfDownload(
    ...
    private fun loadRuData() {
        ...
        listVideo = ArrayList()
        listVideo.clear()
        listVideo.add(Video("Первая помощь при поверхностной ране", "eGrmDmWoauE", ""))
        listVideo.add(Video("Первая помощь при глубокой ране", "CNChAnyvBX8", ""))
        listVideo.add(Video("Первая помощь при переломах", "kUva_nAzWCc", ""))
        listVideo.add(Video("Первая помощь при ожогах", "DBDZnTWHAU8", ""))
        listVideo.add(Video("Первая помощь утопающему ребенку", "456ENmKBLF8", ""))
        list = ArrayList()
        list.clear()
        list.add(
            PdfDownload(
    ...
    companion object {
         ...
         * @return A new instance of fragment BolagaBirinchiYordamVideoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BolagaBirinchiYordamVideoFragment().apply {
