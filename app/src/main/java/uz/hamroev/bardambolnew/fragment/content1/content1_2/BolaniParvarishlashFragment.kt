...
import uz.hamroev.bardambolnew.databinding.FragmentBolaniParvarishlashBinding
 ...
 * Use the [BolaniParvarishlashFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BolaniParvarishlashFragment : Fragment() {
    ...
    lateinit var binding: FragmentBolaniParvarishlashBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBolaniParvarishlashBinding.inflate(layoutInflater, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment BolaniParvarishlashFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BolaniParvarishlashFragment().apply {
