...
import uz.hamroev.bardambolnew.databinding.FragmentQorquvBinding
 ...
 * Use the [QorquvFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class QorquvFragment : Fragment() {
    ...
    lateinit var binding: FragmentQorquvBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentQorquvBinding.inflate(layoutInflater, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment QorquvFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            QorquvFragment().apply {
