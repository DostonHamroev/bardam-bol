package uz.hamroev.bardambolnew.fragment.content2
...
import uz.hamroev.bardambolnew.databinding.FragmentKattalargaBirinchiYordamVideoBinding
 ...
 * Use the [KattalargaBirinchiYordamVideoFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class KattalargaBirinchiYordamVideoFragment : Fragment() {
    ...
    lateinit var binding: FragmentKattalargaBirinchiYordamVideoBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentKattalargaBirinchiYordamVideoBinding.inflate(layoutInflater)
...
//        }
    ...
    private fun loadUzData() {
        ...
        listVideo = ArrayList()
        listVideo.clear()
        listVideo.add(Video("O‘pka-yurak reanimatsiyasi", "HyM0CEsDunE", ""))
        listVideo.add(Video("Hushdan ketish (sinkop, sinkopal holat)", "SJLLmVF_Xg4", ""))
        listVideo.add(Video("Nafas yo‘llariga yot jismlarning tiqilib qolishi", "8UUYAj5E8bM", ""))
        listVideo.add(Video("Tayanch-harakat a’zolarining shikastlanishlari", "AjBGUVClVYk", ""))
            listVideo.add(Video("Elektroshikastlanishlar", "2RoAO5DK7WY", ""))
        listVideo.add(Video("Zaharlanishlar", "Lo-wbnxmxPo", ""))
        listVideo.add(Video("Epilepsiya (tutqanoq kasalligi)", "Zn55YYGCaaU", ""))
        list = ArrayList()
        list.clear()
        list.add(
            PdfDownload(
    ...
    private fun loadKrillData() {
        ...
        listVideo = ArrayList()
        listVideo.clear()
        listVideo.add(Video("Ўпка-юрак реаниматсияси", "HyM0CEsDunE", ""))
        listVideo.add(Video("Ҳушдан кетиш (синкоп, синкопал ҳолат)", "SJLLmVF_Xg4", ""))
        listVideo.add(Video("Нафас йўлларига ёт жисмларнинг тиқилиб қолиши", "8UUYAj5E8bM", ""))
        listVideo.add(Video("Таянч-ҳаракат аъзоларининг шикастланишлари", "AjBGUVClVYk", ""))
        listVideo.add(Video("Электрошикастланишлар", "2RoAO5DK7WY", ""))
        listVideo.add(Video("Заҳарланишлар", "Lo-wbnxmxPo", ""))
        listVideo.add(Video("Эпилепсия (тутқаноқ касаллиги)", "Zn55YYGCaaU", ""))
        list = ArrayList()
        list.clear()
        list.add(
            PdfDownload(
    ...
    private fun loadRuData() {
        ...
        listVideo = ArrayList()
        listVideo.clear()
        listVideo.add(Video("Реанимация легких и сердца", "piH6lQxXB64", ""))
        listVideo.add(Video("Потеря сознания (синкоп, синкопальное состояние)", "ENAGNm2BFpE", ""))
        listVideo.add(Video("Застревание инородных тел в дыхательных органах", "zVwIhwBUtlI", ""))
        listVideo.add(Video("Травмы опорно-двигательного аппарата", "CK8LSxx6XF8", ""))
        listVideo.add(Video("Электроповреждение", "BKf2UKYU39s", ""))
        listVideo.add(Video("Отравления", "AQWAFx97Dy4", ""))
        listVideo.add(Video("Эпилепсия (эпилептический припадок)", "5srmF0VijwY", ""))
        list = ArrayList()
        list.clear()
        list.add(
            PdfDownload(
    ...
    companion object {
         ...
         * @return A new instance of fragment KattalargaBirinchiYordamVideoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            KattalargaBirinchiYordamVideoFragment().apply {
