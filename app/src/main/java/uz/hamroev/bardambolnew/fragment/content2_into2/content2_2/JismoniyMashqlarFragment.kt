...
import uz.hamroev.bardambolnew.databinding.FragmentJismoniyMashqlarBinding
 ...
 * Use the [JismoniyMashqlarFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class JismoniyMashqlarFragment : Fragment() {
    ...
    lateinit var binding: FragmentJismoniyMashqlarBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentJismoniyMashqlarBinding.inflate(layoutInflater)
        checkLanguage()
    ...
    companion object {
         ...
         * @return A new instance of fragment JismoniyMashqlarFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            JismoniyMashqlarFragment().apply {
