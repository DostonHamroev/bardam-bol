...
import uz.hamroev.bardambolnew.databinding.FragmentAldanishlarBinding
 ...
 * Use the [AldanishlarFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class AldanishlarFragment : Fragment() {
    ...
    lateinit var binding: FragmentAldanishlarBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAldanishlarBinding.inflate(layoutInflater, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment AldanishlarFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AldanishlarFragment().apply {
