...
import uz.hamroev.bardambolnew.databinding.FragmentAsabiyTaranglikBinding
 ...
 * Use the [AsabiyTaranglikFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class AsabiyTaranglikFragment : Fragment() {
    ...
    lateinit var binding: FragmentAsabiyTaranglikBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAsabiyTaranglikBinding.inflate(layoutInflater, container, false)
    ...
    private fun loadUzData() {
        ...
        listVideo = ArrayList()
        listVideo.clear()
        listVideo.add(Video("Asabiy zo'riqishni pasaytirish", "CLvt2rVWdyg", ""))
        list = ArrayList()
        list.clear()
        list.add(
            PdfDownload(
    ...
    private fun loadKrillData() {
        ...
        listVideo = ArrayList()
        listVideo.clear()
        listVideo.add(Video("Aсабий зўриқишни пасайтириш", "CLvt2rVWdyg", ""))
        list = ArrayList()
        list.clear()
        list.add(
            PdfDownload(
    ...
    private fun loadRuData() {
        ...
        listVideo = ArrayList()
        listVideo.clear()
        listVideo.add(Video("Cнижения нервно-психического напряжения", "2KSfznuJN1c", ""))
        list.clear()
        list.add(
            PdfDownload(
    ...
    companion object {
         ...
         * @return A new instance of fragment AsabiyTaranglikFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AsabiyTaranglikFragment().apply {
