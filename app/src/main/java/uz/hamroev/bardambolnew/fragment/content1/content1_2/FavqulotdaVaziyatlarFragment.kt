...
import uz.hamroev.bardambolnew.databinding.FragmentFavqulotdaVaziyatlarBinding
 ...
 * Use the [FavqulotdaVaziyatlarFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class FavqulotdaVaziyatlarFragment : Fragment() {
    ...
    lateinit var binding: FragmentFavqulotdaVaziyatlarBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentFavqulotdaVaziyatlarBinding.inflate(layoutInflater, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment FavqulotdaVaziyatlarFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FavqulotdaVaziyatlarFragment().apply {
