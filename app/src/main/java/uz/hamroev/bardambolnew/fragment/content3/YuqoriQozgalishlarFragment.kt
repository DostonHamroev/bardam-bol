...
class YuqoriQozgalishlarFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_yuqori_qozgalishlar, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment YuqoriQozgalishlarFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            YuqoriQozgalishlarFragment().apply {
