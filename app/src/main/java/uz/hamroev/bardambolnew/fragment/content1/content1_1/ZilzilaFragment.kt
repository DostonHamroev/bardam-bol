...
import uz.hamroev.bardambolnew.databinding.FragmentZilzilaBinding
...
class ZilzilaFragment : Fragment() {


    lateinit var binding: FragmentZilzilaBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentZilzilaBinding.inflate(layoutInflater)
    ...
    private fun loadUzData() {
        ...
        listVideo = ArrayList()
        listVideo.clear()
        listVideo.add(Video("Zilzilada inson o'z-o'zini boshqarish choralari", "bVBEAKMEKD4", ""))
    ...
    private fun loadKrillData() {
        ...
        listVideo = ArrayList()
        listVideo.clear()
        listVideo.add(Video("Зилзилада инсон ўз-ўзини бошқариш чоралари", "bVBEAKMEKD4", ""))
    ...
    private fun loadRuData() {
        ...
        listVideo.add(Video("Эвакуация во время землятресения", "3WxuPLFfF78", ""))
        listVideo.add(Video("Землятресение -как природное явление", "98XcalM3oUg", ""))
        list = ArrayList()
        list.clear()
        list.add(
            PdfDownload(
