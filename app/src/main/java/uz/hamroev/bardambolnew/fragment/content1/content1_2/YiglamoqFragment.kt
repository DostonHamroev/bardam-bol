...
import uz.hamroev.bardambolnew.databinding.FragmentYiglamoqBinding
 ...
 * Use the [YiglamoqFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class YiglamoqFragment : Fragment() {
    ...
    lateinit var binding: FragmentYiglamoqBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentYiglamoqBinding.inflate(layoutInflater, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment YiglamoqFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            YiglamoqFragment().apply {
