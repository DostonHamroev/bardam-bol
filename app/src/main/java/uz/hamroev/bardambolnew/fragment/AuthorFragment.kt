...
class AuthorFragment : Fragment() {
    ...
    private fun loadKrillData() {
        ...
        list.add(User("Шарипова Дилара \nДжуманиязовна","\"Зоология ва анатомия\" кафедраси профессори, педагогика фанларни доктори, профессор", R.drawable.ic_dilyara))
        ...
        list.add(User("Достон Ҳамроев \nДавронович","Андроид дастурчи"+ "\nUI дизайнер"+"\nМуҳаммад ал-Хоразмий номидаги Тошкент Ахборот технологиялари университети Телевизион Технологиялари факултети талабаси", R.drawable.ic_doston))
    ...
    private fun loadUzData() {
        ...
        list.add(User("Sharipova Dilara \nJumaniyazovna","\"Zoologiya va anatomiya\" kafedrasi professori, pedagogika fanlarni doktori, professor", R.drawable.ic_dilyara))
