...
import uz.hamroev.bardambolnew.databinding.FragmentGiperativBolagaYordamBinding
 ...
 * Use the [GiperativBolagaYordamFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class GiperativBolagaYordamFragment : Fragment() {
    ...
    lateinit var binding: FragmentGiperativBolagaYordamBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentGiperativBolagaYordamBinding.inflate(layoutInflater)
    ...
    companion object {
         ...
         * @return A new instance of fragment GiperativBolagaYordamFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            GiperativBolagaYordamFragment().apply {
