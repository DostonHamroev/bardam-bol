...
import uz.hamroev.bardambolnew.databinding.FragmentBolaUchunVideoBinding
 ...
 * Use the [BolaUchunVideoFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BolaUchunVideoFragment : Fragment() {
    ...
    lateinit var binding: FragmentBolaUchunVideoBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBolaUchunVideoBinding.inflate(layoutInflater)
...
//        }
    ...
    private fun loadUzData() {
        ...
        listVideo = ArrayList()
        listVideo.clear()
        listVideo.add(Video("Bardam bo'l", "bkuuS7H5VWo", ""))
        listVideo.add(Video("Bo'ronda o'zini qanday tutish kerak", "fXhybznYXd0", ""))
        listVideo.add(Video("Zilzilada o'zingni qanday tutish kerak", "5DvXwqm98MM", ""))
        listVideo.add(Video("Zilzilada o'zingni qanday tutish kerak 1", "0F_OZXTeXJM", ""))
        listVideo.add(Video("Maxluqdan qo'rqmaymiz", "hEPV5f1hvAc", ""))
        listVideo.add(Video("Mikrob, virus va salomat qiz haqida ertak", "zxVMLko5aO4", ""))
        listVideo.add(Video("Sel kelganda o'zingni qanday tutish kerak", "P_OlIf3cSeI", ""))
        listVideo.add(Video("Suv toshqinda o'zningtni qanday tutish kerak", "0VEPXECSuRE", ""))
        listVideo.add(Video("Tun qaytib kel o'yini", "hlOw3Yyi0M0", ""))
        list = ArrayList()
        list.clear()
        list.add(
            PdfDownload(
    ...
    private fun loadKrillData() {
        ...
        listVideo = ArrayList()
        listVideo.clear()
        listVideo.add(Video("Бардам бўл", "bkuuS7H5VWo", ""))
        listVideo.add(Video("Бўронда ўзини қандай тутиш керак", "fXhybznYXd0", ""))
        listVideo.add(Video("Зилзилада ўзингни қандай тутиш керак", "5DvXwqm98MM", ""))
        listVideo.add(Video("Зилзилада ўзингни қандай тутиш керак 1", "0F_OZXTeXJM", ""))
        listVideo.add(Video("Махлуқдан қўрқмаймиз", "hEPV5f1hvAc", ""))
        listVideo.add(Video("Микроб, вирус ва саломат қиз ҳақида эртак", "zxVMLko5aO4", ""))
        listVideo.add(Video("Сел келганда ўзингни қандай тутиш керак", "P_OlIf3cSeI", ""))
        listVideo.add(Video("Сув тошқинда ўзнингтни қандай тутиш керак", "0VEPXECSuRE", ""))
        listVideo.add(Video("Тун қайтиб кел ўйини", "hlOw3Yyi0M0", ""))
        list = ArrayList()
        list.clear()
        list.add(
            PdfDownload(
    ...
    companion object {
         ...
         * @return A new instance of fragment BolaUchunVideoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BolaUchunVideoFragment().apply {
