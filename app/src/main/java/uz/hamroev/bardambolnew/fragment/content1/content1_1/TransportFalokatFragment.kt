...
import uz.hamroev.bardambolnew.databinding.FragmentTransportFalokatBinding
 ...
 * Use the [TransportFalokatFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class TransportFalokatFragment : Fragment() {
    ...
    lateinit var binding: FragmentTransportFalokatBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentTransportFalokatBinding.inflate(layoutInflater, container, false)
    ...
    private fun loadKrillData() {
        ...
        list.add(
            PdfDownload(
                ...
                "Ҳаво транспортидаги ҳалокатида хулқ атвор қоидалари"
            )
        )
    ...
    companion object {
         ...
         * @return A new instance of fragment TransportFalokatFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TransportFalokatFragment().apply {
