...
//        }
    ...
    private fun loadRuData() {
        ...
        listVideo = ArrayList()
        listVideo.clear()
        listVideo.add(Video("Доверяющее падение", "xHf9mpwHQsA", ""))
        ...
        listVideo.add(Video("Игра смелые ребята", "XxQsDMGcljs", ""))
        listVideo.add(Video("Игра для снятия страха", "ma12YOIGwUA", ""))
