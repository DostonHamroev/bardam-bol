...
import uz.hamroev.bardambolnew.databinding.FragmentBolagaPsixologikYordamBinding
 ...
 * Use the [BolagaPsixologikYordamFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BolagaPsixologikYordamFragment : Fragment() {
    ...
    lateinit var binding: FragmentBolagaPsixologikYordamBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBolagaPsixologikYordamBinding.inflate(layoutInflater, container, false)
        checkLanguage()
        loadVideo()
...
//        }
    ...
    private fun loadUzData() {
        ...
        listVideo = ArrayList()
        listVideo.clear()
        listVideo.add(Video("Qo'rquvlar qopchasi", "B8hJZPtI4kE", ""))
//        listVideo.add(Video("Ishonchli tushish", "xHf9mpwHQsA", ""))
//        listVideo.add(Video("Asabiy zo'riqishni yechish uchun o'yin", "ozOBSSS9DwE", ""))
//        listVideo.add(Video("Ishonchli tushish o'yini", "tqB8RYlvSw0", ""))
//        listVideo.add(Video("Tipratikan o'yini", "zEDE9Q7kA4o", ""))
//        listVideo.add(Video("Tipratikan sonini sanang o'yini", "WGYErhAo7cE", ""))
//        listVideo.add(Video("Limon soki o'yini", "AAnk_fe79t0", ""))
//        listVideo.add(Video("Qo'rqmas bolajon o'yini", "XxQsDMGcljs", ""))
//        listVideo.add(Video("Qo'rquvni yengish o'yini", "ma12YOIGwUA", ""))
//        listVideo.add(Video("Ishonchli tushish harakati", "mjEVqY0nWhQ", ""))
        list = ArrayList()
        list.clear()
        list.add(
            PdfDownload(
    ...
    private fun loadKrillData() {
        ...
        listVideo = ArrayList()
        listVideo.clear()
 //       listVideo.add(Video("Қўрқувлар қопчаси", "B8hJZPtI4kE", ""))
//        listVideo.add(Video("Ишончли тушиш", "xHf9mpwHQsA", ""))
//        listVideo.add(Video("Асабий зўриқишни ечиш учун ўйин", "ozOBSSS9DwE", ""))
//        listVideo.add(Video("Ишончли тушиш ўйини", "tqB8RYlvSw0", ""))
//        listVideo.add(Video("Типратикан ўйини", "zEDE9Q7kA4o", ""))
//        listVideo.add(Video("Типратикан сонини сананг ўйини", "WGYErhAo7cE", ""))
//        listVideo.add(Video("Лимон соки ўйини", "AAnk_fe79t0", ""))
//        listVideo.add(Video("Қўрқмас болажон ўйини", "XxQsDMGcljs", ""))
//        listVideo.add(Video("Қўрқувни енгиш ўйини", "ma12YOIGwUA", ""))
//        listVideo.add(Video("Ишончли тушиш ҳаракати", "mjEVqY0nWhQ", ""))
        list = ArrayList()
        list.clear()
        list.add(
            PdfDownload(
    ...
    private fun loadRuData() {
        ...
        listVideo = ArrayList()
        listVideo.clear()
        listVideo.add(Video("Коррекция страхов", "B8hJZPtI4kE", ""))
        //listVideo.add(Video("Коррекция страхов", "xHf9mpwHQsA", ""))
        listVideo.add(Video("Игра для снятия нервного напряжения", "ozOBSSS9DwE", ""))
        listVideo.add(Video("Игра для развития уверенности в себе", "tqB8RYlvSw0", ""))
        //listVideo.add(Video("Игра колючие ёжики", "zEDE9Q7kA4o", ""))
        listVideo.add(Video("ежики - \"коррекция агрессии\"", "WGYErhAo7cE", ""))
        listVideo.add(Video("Лимонный сок- \"игра для преодоления страха в замкнутом пространстве\"", "AAnk_fe79t0", ""))
        //listVideo.add(Video("\"Смелые ребята \" - игра для повышения уверенности в себе", "XxQsDMGcljs", ""))
        listVideo.add(Video("Смелые ребята \\\" - игра для повышения уверенности в себе", "ma12YOIGwUA", ""))
        // listVideo.add(Video("Доверяющее падение в качестве", "mjEVqY0nWhQ", ""))
        list = ArrayList()
        list.clear()
        list.add(
            PdfDownload(
    ...
    companion object {
         ...
         * @return A new instance of fragment BolagaPsixologikYordamFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BolagaPsixologikYordamFragment().apply {
