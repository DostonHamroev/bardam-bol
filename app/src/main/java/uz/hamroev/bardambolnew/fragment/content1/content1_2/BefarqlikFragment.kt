...
import uz.hamroev.bardambolnew.databinding.FragmentBefarqlikBinding
 ...
 * Use the [BefarqlikFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BefarqlikFragment : Fragment() {
    ...
    lateinit var binding: FragmentBefarqlikBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBefarqlikBinding.inflate(layoutInflater, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment BefarqlikFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BefarqlikFragment().apply {
