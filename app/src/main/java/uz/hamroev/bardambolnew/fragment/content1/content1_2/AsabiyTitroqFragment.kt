...
import uz.hamroev.bardambolnew.databinding.FragmentAsabiyTitroqBinding
 ...
 * Use the [AsabiyTitroqFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class AsabiyTitroqFragment : Fragment() {
    ...
    lateinit var binding: FragmentAsabiyTitroqBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAsabiyTitroqBinding.inflate(layoutInflater, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment AsabiyTitroqFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AsabiyTitroqFragment().apply {
